...
const AboutPage = () => (
  <Layout>
    ...
    <div className="insideTrack-container">
      <h3>About OpenSIT</h3>
      <p><a href="https://community.sap.com/events/inside-track/about-inside-track" target="_blank" rel="noopener noreferrer">SAP Inside Tracks</a> are typically one day conferences, locally organised by passioned SAP community members, where knowledge and experience is being shared in talks or sessions. To make their conference content more broadly accessible, an increasing number of SAP Inside Tracks started to live stream and record these sessions.</p>
      ...
      <p>All session recordings are currently hosted on YouTube, distributed across various channels. They are often hard to find and to discover. <a href="https://opensit.net">opensit.net</a> makes all SAP Inside Track session recordings accessible from this website. Available sessions are organised by SAP Inside Tracks and their annual conferences. Each SAP Inside Track page provides links to the respective Twitter hashtag, YouTube account and Twitter channel, if available. Each session page lists the session speakers and, if available, links to their <a href="https://community.sap.com" target="_blank" rel="noopener noreferrer">SAP Community</a> profiles or Twitter accounts.</p>
      ...
      <h3>Data Privacy</h3>
      <p>The <a href="https://opensit.net">opensit.net</a> website aggregates public available information from YouTube and <a href="https://wiki.scn.sap.com" target="_blank" rel="noopener noreferrer">SCN Wiki</a>. The session speakers and their social media profiles are linked, if available. If you like to see your name or content removed from this site, please contact us.</p>
      <p className="pb-5">At this point there is no usage tracking being done on this site. All YouTube videos are embedded with <a href="https://support.google.com/youtube/answer/171780?hl=en">privacy-enhanced mode enabled</a>. Please check out the <Link to="/imprint">imprint</Link> and <Link to="/privacy">privacy</Link> page for additional information</p>
